...
class AddStoryActivity : AppCompatActivity() {
    ...
    private fun submitStory() {
        ...
        if (description.isEmpty() && getFile == null) {
            showErrorMessageDialog(R.string.empty_image_description, R.raw.error)
        } else if (getFile == null) {
            showErrorMessageDialog(R.string.empty_image, R.raw.error)
        } else if (description.isEmpty()) {
            showErrorMessageDialog(R.string.empty_description, R.raw.error)
        } else {
    ...
    private fun observeViewModel() {
        ...
        addStoryViewModel.isError.observe(this) { isError ->
            if (isError) {
                showErrorMessageDialog(R.string.error_server, R.raw.error)
            }
        }
    ...
    private fun resetViews() {
        binding.imgPicker.setAnimation(R.raw.insert_image)
